  ...
  return (
    <div id="aboutPage">
      <div className="qna">
        ...
        <p>
          Licensify is was made with React.js, Node.js, and Express.js. I used React.js and CSS to create the driver license itself and the
      ...
      <div className="qna">
        ...
        <p>
          ...
          All information is used only for generating your driver license. I do not care about your listening activity or Spotify account that much to store your data.
        </p>
        <p>
